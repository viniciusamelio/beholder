...
type EnvironmentRequests struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *EnvironmentRequests) Reset() {
	*x = EnvironmentRequests{}
	mi := &file_schema_schema_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *EnvironmentRequests) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EnvironmentRequests) ProtoMessage() {}

func (x *EnvironmentRequests) ProtoReflect() protoreflect.Message {
	mi := &file_schema_schema_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EnvironmentRequests.ProtoReflect.Descriptor instead.
func (*EnvironmentRequests) Descriptor() ([]byte, []int) {
	return file_schema_schema_proto_rawDescGZIP(), []int{3}
}

func (x *EnvironmentRequests) GetRequests() []*Request {
	if x != nil {
		return x.Requests
	}
	return nil
...
var file_schema_schema_proto_rawDesc = string([]byte{
	...
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x42, 0x0a, 0x13, 0x45, 0x6e, 0x76, 0x69, 0x72,
