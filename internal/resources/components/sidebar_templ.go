...
func Sidebar(envs *[]*models.Environment) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString("</ul></div></div></div></nav><!-- Sidebar Footer --><div class=\"border-t border-border p-4\"><button class=\"w-full flex items-center space-x-3\"><img src=\"https://ui-avatars.com/api/?name=John+Doe\" class=\"w-8 h-8 rounded-full\"><div class=\"flex-1 text-left\"><div class=\"text-sm font-medium\">John Doe</div><div class=\"text-xs text-gray-500\">john@example.com</div></div><i class=\"ri-more-line\"></i></button></div></aside>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
