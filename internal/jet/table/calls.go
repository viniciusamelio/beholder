...
func newCallsTableImpl(schemaName, tableName, alias string) callsTable {
	var (
		...
		allColumns          = sqlite.ColumnList{IDColumn, SessionIDColumn, EnvironmentIDColumn, NameColumn, MethodColumn, PathColumn, BodyColumn, QueryParamsColumn, UserIDColumn, CalledAtColumn, CreatedAtColumn, UpdatedAtColumn}
		mutableColumns      = sqlite.ColumnList{SessionIDColumn, EnvironmentIDColumn, NameColumn, MethodColumn, PathColumn, BodyColumn, QueryParamsColumn, UserIDColumn, CalledAtColumn, CreatedAtColumn, UpdatedAtColumn}
	)
